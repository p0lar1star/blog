...
![image-20210323125655409](https://abc.p0lar1s.com/202110282233291.png)

/dev/random和/dev/urandom是unix系统提供的产生随机数的设备，先产生一个随机数

![image-20210323125757017](https://abc.p0lar1s.com/202110282233176.png)



输入放到buf里，然后与随机数比较，不等的话程序就结束了，于是将输入的第一个字母弄成'\0'，以绕过strncmp

![image-20210323134424388](https://abc.p0lar1s.com/202110282233847.png)
...
![image-20210323205003536](https://abc.p0lar1s.com/202110282233703.png)
...
![image-20210324013926574](https://abc.p0lar1s.com/202110282233356.png)
...
![image-20210324184629690](https://abc.p0lar1s.com/202110282233971.png)
...
![2](https://abc.p0lar1s.com/202110282234243.png)
...
![1](https://abc.p0lar1s.com/202110282234320.png)

'sh'在这里：

![image-20210325152900698](https://abc.p0lar1s.com/202110282237206.png)
...
![image-20210325212425076](https://abc.p0lar1s.com/202110282238787.png)

第一次输入长度不超过四位的整数，在get_n函数中对输入的数字做出了限制，一个一个读入数字，且不能是'\0'

第一次输入的数字不能大于32，这显然不够溢出，但是可以注意到，get_n函数第二个实参v2是有符号的，而在函数中转变成无符号类型

![image-20210325212820362](https://abc.p0lar1s.com/202110282238595.png)

get_n的第二个形参**a2是无符号整型**，并且它没有对我们输入的第二个参数a2做无符号整数判断。而**有符号负数**到**无符号数**是**会发生溢出的。**

![image-20210325213708476](https://abc.p0lar1s.com/202110282238179.png)

写exp的时候注意一下用printf泄露地址时格式化字符串的位置和payload的写法即可

![1](https://abc.p0lar1s.com/202110282238574.png)
...
![image-20210327012738383](https://abc.p0lar1s.com/202110282238605.png)
...
![image-20210327014136636](https://abc.p0lar1s.com/202110282238898.png)
...
![image-20210327225819899](https://abc.p0lar1s.com/202110282238071.png)

![image-20210327225909892](https://abc.p0lar1s.com/202110282238246.png)
...
![img](https://abc.p0lar1s.com/202110282238678.png)

栈劫持主要用到的是一个leave；ret指令，一般程序执行完成后都会调用leave；ret来还原现场

![img](https://abc.p0lar1s.com/202110282238084.png)

找一下程序里的leave；ret指令，leave_ret=0x8048408

![img](https://abc.p0lar1s.com/202110282239028.png)
...
![img](https://abc.p0lar1s.com/202110282239226.png)

根据我们对栈的布局，
`mov esp，ebp`->将esp指向了ebp，栈变成了这个样子

![img](https://abc.p0lar1s.com/202110282239466.png)
...
![img](https://abc.p0lar1s.com/202110282239735.png)
...
![img](https://abc.p0lar1s.com/202110282239624.png)

`pop ebp`->弹出栈顶的值给ebp，之后栈变成了这样，我们成功将esp指针劫持到了我们布置好的栈上

![img](https://abc.p0lar1s.com/202110282239367.png)
...
![image-20210328002104313](https://abc.p0lar1s.com/202110282239187.png)
...
![image-20210328190152013](https://abc.p0lar1s.com/202110282239962.png)

也就是说，在retn前直接修改了esp的值，这个值是ecx-4的值，而ecx由ebp-4中的值控制，故不能直接确定ret时esp指向的指是多少

我通过gdb找到了真正的偏移为1052

![1](https://abc.p0lar1s.com/202110282240175.png)

ret时，esp为0xffffd58c，在此前打印出buf地址为0xffffd170，相减得偏移为1052

![image-20210328190918543](https://abc.p0lar1s.com/202110282240885.png)
...
![image-20210329010416720](https://abc.p0lar1s.com/202110282240273.png)

![image-20210329010434632](https://abc.p0lar1s.com/202110282240690.png)

随便输入，会发现除了输出1234外，还会输出奇奇怪怪的东西，原因是显而易见的，输出的长度大于栈空间的长度

![image-20210329010520481](https://abc.p0lar1s.com/202110282240879.png)

那么输出的是什么呢？

![image-20210329010721041](https://abc.p0lar1s.com/202110282240562.png)
...
![image-20210329011902336](https://abc.p0lar1s.com/202110282240527.png)
...
![1](https://abc.p0lar1s.com/202110282241318.png)

如图0xc8d8 - 0xc7a0 = 0x138

为调用64位的syscall，rdi要存放'/bin/sh'的地址，rsi和rdx都要置零

![image-20210329235922650](https://abc.p0lar1s.com/202110282241372.png)

可是好像没有找到给rdx置零的gadget啊，怎么办呢，我们看到函数__libc_csu_init，利用这个函数里面的汇编片段，我们可以控制rdx和rsi寄存器的值

![image-20210330000043379](https://abc.p0lar1s.com/202110282241633.png)
...
![image-20210331172338405](https://abc.p0lar1s.com/202110282241427.png)
...
![img](https://abc.p0lar1s.com/202110282241513.jpeg)
...
![1](https://abc.p0lar1s.com/202110282242765.png)

![2](https://abc.p0lar1s.com/202110282242694.png)

还有一个最关键的一点，就是怎么泄露canary的值？第一个scanf的时候，我们要输入什么？再具体一点，canary的值是printf的第几个参数？（或者说，偏移为几？）

动态调试看一下：

![image-20210404154522067](https://abc.p0lar1s.com/202110282243644.png)
...
![image-20210408163236568](https://abc.p0lar1s.com/202110282244699.png)

![image-20210408163518505](https://abc.p0lar1s.com/202110282244131.png)

我决定把shellcode放在0xff90c4f0的位置（ebp + 0x8），然后计算这个地方和泄露的栈地址之间的偏移量位0x1C

![image-20210408164419433](https://abc.p0lar1s.com/202110282244569.png)
...
![image-20210408211214397](https://abc.p0lar1s.com/202110282245524.png)

由于在改变数组中的元素时未验证下标的有效性，导致我们可以任意写（这种漏洞的本质应该就是C语言用偏移来计算真实地址）

![image-20210408195827299](https://abc.p0lar1s.com/202110282245205.png)

在栈上找到数组和我们输入的数（读入时查看数组在内存中的地址）：

![image-20210408211144722](https://abc.p0lar1s.com/202110282245621.png)

和返回地址（执行到retn时查看esp位置）：

**切记这里不能用ebp+0x4来算esp，因为这里esp的值是通过lea esp, [ecx-4]得到的，也就是说返回地址并不是保存在ebp+0x4处(并不等于[ebp+0x4])**

![image-20210408211006009](https://abc.p0lar1s.com/202110282245520.png)

![image-20210408211036271](https://abc.p0lar1s.com/202110282245173.png)

由于存在相当明显的后门函数，我们利用任意写改掉返回地址就行，注意写的顺序，因为内存中是小端序，所以如果地址是0x12345678，逐个输入78 56 34 12  

![image-20210408200256615](https://abc.p0lar1s.com/202110282245871.png)
...
![image-20210409105933197](https://abc.p0lar1s.com/202110282245419.png)
...
![image-20210409123959795](https://abc.p0lar1s.com/202110282245146.png)
...
![image-20210410021229743](https://abc.p0lar1s.com/202110282245890.png)

调试发现实际上本应该成为第8个参数'12345678'的首位是在第7个参数（也就是偏移为7）的末位，如下图

![image-20210410022720826](https://abc.p0lar1s.com/202110282246670.png)

补一个字符可以让我们想要输出的东西正好落在偏移为8处

![image-20210410024533057](https://abc.p0lar1s.com/202110282246427.png)
...
![image-20210410221907586](https://abc.p0lar1s.com/202110282246088.png)
...
![image-20210410221835050](https://abc.p0lar1s.com/202110282246920.png)
...
![image-20210413144424312](https://abc.p0lar1s.com/202110282248908.png)
...
![image-20210413144652165](https://abc.p0lar1s.com/202110282248956.png)

# [ZJCTF 2019]Login

用C++写的程序，需要一定的分析

![image-20210413173857371](https://abc.p0lar1s.com/202110282248674.png)

有后门

![image-20210413175751724](https://abc.p0lar1s.com/202110282248718.png)

如下两图，不难发现Admin是User的子类。在上图中第16行，初始化了一个Admin对象，其用户名为admin，密码为2jctf_pa5sw0rd

![image-20210413174015284](https://abc.p0lar1s.com/202110282248382.png)

![image-20210413174206811](https://abc.p0lar1s.com/202110282248218.png)
...
![image-20210413175458125](https://abc.p0lar1s.com/202110282248469.png)

gdb发现第二个check_password函数里面有call rax

![image-20210413175541155](https://abc.p0lar1s.com/202110282249336.png)

如何才能利用呢？当然是把rax改成后门函数的地址

![image-20210413180901421](https://abc.p0lar1s.com/202110282248918.png)

call rax之前还得解两次引用，我们把第二次解引用前rax保存的地址(即下图中rax寄存器保存的0x7fffffffdc18)处保存的地址改为后门函数的地址(0x0400E88)即可

![image-20210413181220856](https://abc.p0lar1s.com/202110282249383.png)

重新运行，密码输入12345678，从下两张图可以看出偏移为0x7fffffffdbd0 - 0x7fffffffdc18 = 0x48 = 72

![image-20210413181633215](https://abc.p0lar1s.com/202110282249925.png)

![image-20210413181737293](https://abc.p0lar1s.com/202110282249530.png)
...
![image-20210413205335154](https://abc.p0lar1s.com/202110282249971.png)

嚯，好简单のpwn，写入shellcode（int 0x80），然后满怀期待地看着屏幕弹出EOFError……

![image-20210413210052766](https://abc.p0lar1s.com/202110282249710.png)
...
![image-20210414213137159](https://abc.p0lar1s.com/202110282250122.png)
...
![image-20210417004808227](https://abc.p0lar1s.com/202110282250232.png)

Partial RELRO，考虑直接改got表，把strlen的got表值改成system的，传入'/bin/sh'

但是题目没有给后门函数，所以还要泄露libc基址，我这里从printf的真实地址入手来计算libc的基地址

![image-20210417004712782](https://abc.p0lar1s.com/202110282249247.png)

如图，我们输入的东西在栈中并不是对齐的，这和此前一个题较为相似，我们在payload最开始要加一个字母确保我们的地址落在正确的偏移处

![image-20210417170437881](https://abc.p0lar1s.com/202110282250848.png)
...
![image-20210418010221687](https://abc.p0lar1s.com/202110282250509.png)

改正后：

![image-20210418010828561](https://abc.p0lar1s.com/202110282250438.png)
...
![image-20210418164119314](https://abc.p0lar1s.com/202110282250190.png)
...
![image-20210419165835047](https://abc.p0lar1s.com/202110282251409.png)

![image-20210419165753744](https://abc.p0lar1s.com/202110282251280.png)
...
![image-20210419170306702](https://abc.p0lar1s.com/202110282251508.png)
...
![image-20210421004709386](https://abc.p0lar1s.com/202110282251538.png)
...
![image-20210421004509293](https://abc.p0lar1s.com/202110282251300.png)
...
![image-20210421160151103](https://abc.p0lar1s.com/202110282253834.png)
...
![image-20210421161356582](https://abc.p0lar1s.com/202110282253270.png)

# npuctf_2020_level2

第一次做非栈上的格式化字符串题目，检查保护，除了canary都开了

![image-20210422172755880](https://abc.p0lar1s.com/202110282254807.png)

主函数就是这么简单：

![image-20210422172913838](https://abc.p0lar1s.com/202110282254663.png)
...
![image-20210422184345981](https://abc.p0lar1s.com/202110282254078.png)

首先，需要知道libc的基地址，这需要我们泄露栈上的某一个libc地址，如下图，程序的返回地址就是libc中的某一个地址，且是格式化字符串的第七个参数

![image-20210422181821606](https://abc.p0lar1s.com/202110282339511.png)

因为输入的内容全都在bss段，我们不能通过'%n'来改变我们输入的任意地址的值，但我们可以通过间接的方式来改变。接下来我们需要**地址链**来完成攻击。通常地址链由三个栈空间的地址组成。如下图

![image-20210422183254690](https://abc.p0lar1s.com/202110282254920.png)

常用的地址链有：rbp指针链、args参数链
（如果利用rbp指针链进行攻击，注意最后退出函数的时候，需要把rbp指针链恢复为原始状态。）

![image-20210422183424934](https://abc.p0lar1s.com/202110282301688.png)
...
![image.png](https://abc.p0lar1s.com/202110282305006.png)
...
![image.png](https://abc.p0lar1s.com/202110282306223.png)
...
![image.png](https://abc.p0lar1s.com/202110282306104.png)
...
![image.png](https://abc.p0lar1s.com/202110282307474.png)
...
![image-20210423124226845](https://abc.p0lar1s.com/202110282308261.png)

main函数在程序**执行后都会进入fini_array**

![img](https://abc.p0lar1s.com/202110282308218.png)

![image-20210423131159252](https://abc.p0lar1s.com/202110282308935.png)
...
![image-20210423131034287](https://abc.p0lar1s.com/202110282308294.png)

![image-20210423131232360](https://abc.p0lar1s.com/202110282308580.png)

![image-20210423131833596](https://abc.p0lar1s.com/202110282310838.png)

![image-20210423131859275](https://abc.p0lar1s.com/202110282310203.png)
...
![image-20210423175156222](https://abc.p0lar1s.com/202110282308566.png)
...
![image-20210424212533523](https://abc.p0lar1s.com/202110282330224.png)

在ida中已经重命名各个函数，start函数就是这么简单，没有main函数，应该是用汇编写的

![image-20210424212145771](https://abc.p0lar1s.com/202110282330438.png)

vul函数中存在明显的栈溢出，但是本题的read、write函数都是用系统调用实现的，根本没有用到libc，**只能通过系统调用的open函数打开flag文件读取内容发并输出**

![image-20210424212254368](https://abc.p0lar1s.com/202110282330167.png)
...
![image-20210425201517814](https://abc.p0lar1s.com/202110282330860.png)

使用seccomp-tools查看沙盒ban掉了哪些系统调用，execve赫然在列

![image-20210425201730014](https://abc.p0lar1s.com/202110282330166.png)

查看漏洞函数

![image-20210425201655205](https://abc.p0lar1s.com/202110282330437.png)
...
![image-20210425204252531](https://abc.p0lar1s.com/202110282331285.png)

如下图，把libc拖进ida，crtl+s即可看到libc的bss段偏移为0x3c5720

![image-20210425214934992](https://abc.p0lar1s.com/202110282331437.png)
...
![image-20210425205354107](https://abc.p0lar1s.com/202110282331941.png)
...
![image-20210425205554236](https://abc.p0lar1s.com/202110282331254.png)

出题人：想不到吧！真正的syscall在_syscall函数里面！（你坏坏）

![image-20210425205738544](https://abc.p0lar1s.com/202110282331524.png)
...
![img](https://abc.p0lar1s.com/202110282332137.jpeg)
...
![image-20210427020158833](https://abc.p0lar1s.com/202110282332788.png)
...
![image-20210427221116311](https://abc.p0lar1s.com/202110282333119.png)

![image-20210427221139423](https://abc.p0lar1s.com/202110282333117.png)
...
![image-20210429002021225](https://abc.p0lar1s.com/202110282333690.png)

主函数如下，部分变量已经跟据我自己的理解进行了改名

![image-20210429002132913](https://abc.p0lar1s.com/202110282333126.png)

验证函数：

![image-20210429002230518](https://abc.p0lar1s.com/202110282333043.png)

后门函数

![image-20210429002252807](https://abc.p0lar1s.com/202110282333106.png)
...
![image-20210429151535093](https://abc.p0lar1s.com/202110282333389.png)
...
![image-20210429152149569](https://abc.p0lar1s.com/202110282333115.png)
...
![image-20210429214739640](https://abc.p0lar1s.com/202110282333621.png)

第一次做计算程序加载基址的题目。其实原理也挺简单，泄露某条指令地址，如main+74，基址就是这个地址减去74减去main函数的偏移。

0x555555554a03-74-0x555555554000=0x9b9

![1](https://abc.p0lar1s.com/202110282333447.png)
...
![image-20210504164058616](https://abc.p0lar1s.com/202110282339016.png)

输入ll可查看各文件的rwx权限，我们不是root用户，对flag没有读的权限

![image-20210504164338489](https://abc.p0lar1s.com/202110282333174.png)
...
![image-20210504165448942](https://abc.p0lar1s.com/202110282334350.png)

如图，输入大量字符即可

![image-20210504165634548](https://abc.p0lar1s.com/202110282334146.png)

# starctf_2019_babyshell

开了一块内存给我们放shellcode

![image-20210505140842287](https://abc.p0lar1s.com/202110282334937.png)

难处在于有检查，检查函数如下：

![image-20210505140942702](https://abc.p0lar1s.com/202110282334656.png)
...
![image-20210507010440797](https://abc.p0lar1s.com/202110282334143.png)

猜数函数如下

![image-20210507010601492](https://abc.p0lar1s.com/202110282334184.png)
...
![image-20210507021300007](https://abc.p0lar1s.com/202110282334859.png)

![image-20210507021520925](https://abc.p0lar1s.com/202110282334411.png)
...
![image-20210507024440005](https://abc.p0lar1s.com/202110282334234.png)
...
![image-20210507163306988](https://abc.p0lar1s.com/202110282334899.png)

main函数如下：

![image-20210507162659332](https://abc.p0lar1s.com/202110282334743.png)

![image-20210507162748389](https://abc.p0lar1s.com/202110282334322.png)

运行界面：

![image-20210507162825661](https://abc.p0lar1s.com/202110282335741.png)
...
![image-20210507162350702](https://abc.p0lar1s.com/202110282336272.png)
...
![image-20210507192800250](https://abc.p0lar1s.com/202110282335853.png)

主函数中，先是settreasure函数，不明所以，对整个题目也没有什么作用

![image-20210507192728644](https://abc.p0lar1s.com/202110282335871.png)

接下来是treasure函数，首先再bss段上开辟了一块长度为10字节大小的可读可写可执行代码段code，第一个字节放字母，最终留给我们写shellcode的空间只有9字节，这么短的空间写什么shellcode呢？

![image-20210507192857610](https://abc.p0lar1s.com/202110282335814.png)
...
![image-20210507204739191](https://abc.p0lar1s.com/202110282335321.png)

主函数如下：

![image-20210507204808529](https://abc.p0lar1s.com/202110282336304.png)

初始化函数如下，可以看到产生了两个随机数并且以此为基础分配了两块内存空间，一块可读可写可执行，另一块可写可执行

![image-20210507204838803](https://abc.p0lar1s.com/202110282335179.png)
...
![image-20210507205358268](https://abc.p0lar1s.com/202110282336145.png)

在出题人给我们写好的初始化shellcode中，一开始又非常刻意的将可写可执行的区域的地址从rdi交给了rsp，显然在执行shellcode时，rip是指向可读可写可执行的那块内存

![image-20210507205508171](https://abc.p0lar1s.com/202110282335201.png)
...
![img](https://abc.p0lar1s.com/202110282335853.jpeg)
...
![image-20210508150127087](https://abc.p0lar1s.com/202110282335858.png)

start函数如下（真的很小）：

![image-20210508150050575](https://abc.p0lar1s.com/202110282335143.png)
...
![image-20210508155707660](https://abc.p0lar1s.com/202110282336294.png)

# 0ctf2017_easiestprintf

检查保护：

![image-20210508165154531](https://abc.p0lar1s.com/202110282335348.png)
...
![image-20210508171134144](https://abc.p0lar1s.com/202110282335174.png)

do_read函数实现了任意读

![image-20210508171235004](https://abc.p0lar1s.com/202110282337899.png)

leave函数中有格式化字符串漏洞

![image-20210508171308198](https://abc.p0lar1s.com/202110282335857.png)
